...
describe("ssr", async () => {
  ...
  it("renders the index page with a single simple element", async () => {
    ...
    expect(html).toContain('<my-element defer-hydration="true"><template shadowrootmode="open"><style>');
  ...
  it("renders multiple different element tags when supplied", async () => {
    ...
    expect(html).toContain('<my-element defer-hydration="true"><template shadowrootmode="open"><style>');
    expect(html).toContain("<!--/lit-part--></template>I am a SSR-ed Lit element</my-element>");
    expect(html).toContain('<simple-button defer-hydration="true"><template shadowrootmode="open"><style>');
  ...
  it("renders component attributes", async () => {
    ...
    expect(html).toContain('<simple-button disabled defer-hydration="true"><template shadowrootmode="open"><style>');
  });
